...
{/* @generated SignedSource<<69fa81c78d7a7da14ba92593b9e2b4b3>> */}
...
| `--version`  | `string`, default: `"1.0.0-beta.0"` | Version of oneRepo to install. Defaults to the current version.                                                     |
