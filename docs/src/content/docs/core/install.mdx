...
{/* @generated SignedSource<<0764877daaaa17709a08ccb0916d4472>> */}
...
| `--version`  | `string`, default: `"1.0.0-beta.1"` | Version of oneRepo to install. Defaults to the current version.                                                     |
