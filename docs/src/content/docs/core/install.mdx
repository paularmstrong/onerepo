...
{/* @generated SignedSource<<6b1c71464ca2a4be3b65e8a3614b1e10>> */}
...
| `--version`  | `string`, default: `"1.0.0-beta.2"` | Version of oneRepo to install. Defaults to the current version.                                                     |
