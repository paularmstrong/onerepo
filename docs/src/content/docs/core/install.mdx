...
{/* @generated SignedSource<<d25c0525c4fe86a57bc405a8d7deea7c>> */}
...
| `--version`  | `string`, default: `"1.0.0-beta.3"` | Version of oneRepo to install. Defaults to the current version.                                                     |
