...
export default {
	outDir: () =>
		path.join(fileURLToPath(import.meta.url), '../../../path/to/output'),
};
```
...
export default {
	...
	outDir: () =>
		path.join(fileURLToPath(import.meta.url), '../../../path/to/modules'),
	prompts: [
		{
			name: 'name',
...
{/* @generated SignedSource<<b4d9871d1341298fc3628c61ea91a856>> */}
