...
{/* @generated SignedSource<<cc7b20bfab47baae5a8d07464cfa2112>> */}

### RootConfig\<CustomLifecycles\>

- **Type:** `object`

Defined in: config-root.d.ts:7
...
{/* @generated SignedSource<<50c6de5753561790ff810ec61950c599>> */}

### WorkspaceConfig\<CustomLifecycles\>

- **Type:** `object`

Defined in: config-workspace.d.ts:5
