...
Jest is a good framework for headless testing with oneRepo. Jest works well because it allows a single runner that can use multiple project configurations. Each workspace in your repository can be a Jest project, enabling Jest to determine which tests to run.
...
{/* @generated SignedSource<<347453289f233a73126de352538f5cf4>> */}
...
{/* @generated SignedSource<<36e6075a2347dd94f8864a29cc11bcb5>> */}
...
```sh
one jest ,test [options...] -- [passthrough]
one jest [options...]
```
