...
**Source:** [jest/index.ts](https://github.com/paularmstrong/onerepo/blob/112f90d/plugins/jest/src/index.ts#L47)
...
| :------- | :--------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `config` | `string`               | Specify the main Jest configuration file, if different from `<repo>/jest.config.js`. This can be relative to the repository root.<br /><br />**Example**<br />`js jest({ 	config: 'configs/jest/config.js' }); ` |
| `name`   | `string` \| `string`[] | Rename the default command name.                                                                                                                                                                                |

**Source:** [jest/index.ts](https://github.com/paularmstrong/onerepo/blob/112f90d/plugins/jest/src/index.ts#L17)
