...
**Source:** [vitest/index.ts](https://github.com/paularmstrong/onerepo/blob/112f90d/plugins/vitest/src/index.ts#L38)
...
**Source:** [vitest/index.ts](https://github.com/paularmstrong/onerepo/blob/112f90d/plugins/vitest/src/index.ts#L17)
