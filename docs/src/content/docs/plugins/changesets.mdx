...
description: Official Changesets plugin for the oneRepo toolchain.
sidebar:
  label: Changesets
meta:
  version: 0.9.6
...
<NpmToYarn script="npm install --save-dev @onerepo/plugin-changesets" />
...
**Source:** [changesets/index.ts](https://github.com/paularmstrong/onerepo/blob/112f90d/plugins/changesets/src/index.ts#L36)
...
**Source:** [changesets/index.ts](https://github.com/paularmstrong/onerepo/blob/112f90d/plugins/changesets/src/index.ts#L19)
