...
If you're also running [ESLint](/plugins/eslint/), it is important to run Prettier _after_ ESLint. Do this by creating [sequential tasks](/core/tasks/#sequential-tasks): an array of tasks within the `serial` tasks array:
