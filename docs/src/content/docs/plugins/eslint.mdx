...
{/* @generated SignedSource<<946dcf9ff7e6865568f04464212e88df>> */}
...
If you're also running [Prettier](/plugins/prettier/), it is important to run ESLint \_before\_\_ Prettier. Do this by creating [sequential tasks](/core/tasks/#sequential-tasks): an array of tasks within the `serial` tasks array:

```ts title="./onerepo.config.ts" ins={7,12}
import type { Config } from 'onerepo';
