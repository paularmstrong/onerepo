...
Eslint 9 moved from a multi-rc/cascading config system to [flat configs](https://eslint.org/blog/2022/08/new-config-system-part-2/). As welcome of a change this was, it broke one of the fundamental tenets of monorepos: as much as possible for a workspace should be contained within the workspace and should not pollute the global scope.
...
3. **Add Workspace configs**
   ...
   export default tseslint.config({ ignores: '.astro/**' }, ...pluginAstro.configs.recommended, {
   	rules: {
...
{/* @generated SignedSource<<29eb162ec36b1f5966063065e1245213>> */}
...
Defined in: [index.ts:44](https://github.com/paularmstrong/onerepo/blob/main/plugins/eslint/src/index.ts)
