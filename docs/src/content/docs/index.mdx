...
<CardGrid stagger>
	<Card title="Easy to use" icon="information">
		...
		<abbr title="command-line interface">CLI</abbr> with tab completion with
	...
	<Card title="Safe & strict" icon="approve-check-circle">
		Avoid common pitfalls and mistakes when working in a monorepo with
		[workspace validation](/core/graph/#validating-configurations).
	</Card>
	<Card title="Extendable" icon="puzzle">
		Includes [first-party plugins](/plugins/) and a robust extendable
		architecture to customize to your team’s needs.
	</Card>
</CardGrid>
