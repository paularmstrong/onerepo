...
[32m@internal-tests/todo-list-cli:integration:[0m +++
[32m@internal-tests/todo-list-cli:integration:[0m
[32m@internal-tests/todo-list-cli:integration:[0m dependencies:
[32m@internal-tests/todo-list-cli:integration:[0m + @internal-tests/todo-list-cli 0.0.0-development
[32m@internal-tests/todo-list-cli:integration:[0m + @types/node 16.11.41
[32m@internal-tests/todo-list-cli:integration:[0m + typescript 4.7.3
[32m@internal-tests/todo-list-cli:integration:[0m
[32m@internal-kit/ts:setup:integration:[0m Progress: resolved 117, reused 110, downloaded 1, added 0
[32m@internal-tests/todo-list-cli:integration:[0m Progress: resolved 3, reused 2, downloaded 1, added 3, done
[32m@internal-tests/todo-list-cli:integration:[0m
[32m@internal-kit/ts:setup:integration:[0m Progress: resolved 219, reused 208, downloaded 1, added 0
[32m@internal-tests/todo-list-cli:integration:[0m [32;1m PASS [0m src/__integration__/usingCli.test.ts
[32m@internal-kit/ts:setup:integration:[0m Progress: resolved 310, reused 292, downloaded 1, added 0
[32m@internal-kit/ts:setup:integration:[0m Progress: 421, reused 402, downloaded 1, added 0
[32m@internal-tests/todo-list-cli:integration:[0m [32;1m PASS [0m src/__integration__/usingAsLibrary.test.ts
[32m@internal-tests/todo-list-cli:integration:[0m
[32m@internal-tests/todo-list-cli:integration:[0m Test Suites:  [32;1m2 passed[0m, 2 total
[32m@internal-tests/todo-list-cli:integration:[0m Tests:        [32;1m2 passed[0m, 2 total
[32m@internal-tests/todo-list-cli:integration:[0m Snapshots:    [32;1m8 passed[0m, 8 total
[32m@internal-tests/todo-list-cli:integration:[0m Time:         2.9122s, estimated 3 s
[32m@internal-tests/todo-list-cli:integration:[0m Ran all test suites.
```
